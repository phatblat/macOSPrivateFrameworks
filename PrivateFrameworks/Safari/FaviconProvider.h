...
@class FaviconProviderHistoryBookmarkAdapter, FaviconProviderIconControllerDatabaseStore, FaviconProviderPersistenceController, NSCache, NSCalendar, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSString, NSURL, NSUserDefaults;
