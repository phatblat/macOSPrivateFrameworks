...
- (NSString *)name;
- (void)updateStorageWithAddedEvents:(NSArray *)arg1 deletedEventIDs:(NSArray *)arg2 highPriority:(BOOL)arg3 completion:(void (^)(NSError *))arg4;
...
- (void)fetchDeletedEventIDsFromPeer:(_DKSyncPeer *)arg1 sinceDate:(NSDate *)arg2 streamNames:(NSArray *)arg3 highPriority:(BOOL)arg4 completion:(void (^)(NSArray *, NSDate *, NSError *))arg5;
