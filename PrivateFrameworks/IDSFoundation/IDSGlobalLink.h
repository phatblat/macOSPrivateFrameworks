...
- (BOOL)link:(id)arg1 didReceivePacket:(CDStruct_e844bd1c *)arg2 fromDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;
...
- (BOOL)_getPacketBufferSendInfo:(CDStruct_e844bd1c *)arg1 channelNumber:(unsigned short *)arg2 transport:(long long *)arg3;
...
- (void)_processReallocChannelData:(CDStruct_e844bd1c *)arg1 channelNumber:(unsigned short)arg2 fromDeviceUniqueID:(id)arg3 cbuuid:(id)arg4 arrivalTime:(double)arg5;
...
- (BOOL)_processStunPacket:(CDStruct_e844bd1c *)arg1 fromDeviceUniqueID:(id)arg2 cbuuid:(id)arg3 arrivalTime:(double)arg4 headerOverhead:(unsigned long long)arg5;
