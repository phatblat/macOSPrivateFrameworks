...
@class INCodableAttribute, NSString, _INPBIntentMetadata, _INPBLocation;

@interface _INPBListRideOptionsIntent : PBCodable <_INPBListRideOptionsIntent, NSSecureCoding, NSCopying, INCodableAttributeAssociating>
{
    struct _has;
