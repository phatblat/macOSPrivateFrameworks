...
@class INCodableAttribute, NSString, _INPBDataString, _INPBValueMetadata;

@interface _INPBBillPayeeValue : PBCodable <_INPBBillPayeeValue, NSSecureCoding, NSCopying, INCodableAttributeAssociating>
{
    struct _has;
