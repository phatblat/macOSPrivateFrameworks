...
@class INCodableAttribute, NSString, _INPBFilePropertyValue;

@interface _INPBFileProperty : PBCodable <_INPBFileProperty, NSSecureCoding, NSCopying, INCodableAttributeAssociating>
{
    struct {
        unsigned int name:1;
