...
+ (void)initialize;
@property(nonatomic) BOOL artworkURLTemplateAvailable; // @synthesize artworkURLTemplateAvailable=_artworkURLTemplateAvailable;
...
@property(readonly, nonatomic) BOOL hasArtworkURLTemplatesDataDeprecated;
