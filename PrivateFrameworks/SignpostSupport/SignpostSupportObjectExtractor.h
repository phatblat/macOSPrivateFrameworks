...
@class NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSObject<OS_xpc_object>, SignpostIntervalBuilder, SignpostSupportObjectFilter, SignpostSupportSubsystemCategoryFilter;
