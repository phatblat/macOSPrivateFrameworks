...
@class AVCRemoteVideoClient, HMDAudioStreamInterface, HMDCameraSessionID, HMDCameraStreamSnapshotHandler, HMDVideoStreamInterface, NSNumber, NSObject<OS_dispatch_queue>, NSString;
