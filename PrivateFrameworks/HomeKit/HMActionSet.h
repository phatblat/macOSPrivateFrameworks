...
@class HMApplicationData, HMDelegateCaller, HMFMessageDispatcher, HMHome, HMThreadSafeMutableArrayCollection, NSDate, NSObject<OS_dispatch_queue>, NSSet, NSString, NSUUID;
