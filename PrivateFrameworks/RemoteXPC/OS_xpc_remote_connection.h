...
@class NSObject<OS_dispatch_queue>, NSObject<OS_nw_connection>, NSObject<OS_nw_listener>, NSString, OS_remote_service, OS_xpc_remote_channel, OS_xpc_remote_listener, OS_xpc_remote_message, OS_xpc_remote_outstanding_reply, OS_xpc_remote_pending_stream;
