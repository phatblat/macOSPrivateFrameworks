...
@class AKAuthWebTabView, AKKeepUsingController, AKNoCodeReceivedController, AKSecondFactorCodeEntryController, AKSignInPromptController, AKTooManyAttemptsController, CDPEnrollViewController, NSImageView, NSMutableArray, NSString, NSTouchBar, NSURLRequest, NSView, NSWindow;
