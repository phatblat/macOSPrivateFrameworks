...
@class AKAuthWebTabView, AKInAssistantSecondFactorCodeEntry, AKiCDPDeviceValidationFlowViewController, AKiCDPRecoveryKeyViewController, CDPRemoteDeviceSecretValidator, NSArray, NSMutableArray, NSMutableDictionary, NSObject<AKAppleIDAuthenticationAssistant>, NSProgressIndicator, NSSecureTextField, NSString, NSTextField;

@interface AKAppleIDAuthenticationInAssistantContext : AKAppleIDAuthenticationContext <AKAppleIDAuthenticationUIProvider, NSTextFieldDelegate, AuthWebViewDelegate, MBUIDelegate, MBWebKitViewControllerDelegate, AKSecondFactorCodeEntryDelegate, AKiCDPValidationDelegate, AKiCDPRecoveryKeyDelegate, NSSecureCoding>
{
