...
@class AKAppleIDAuthenticationController, AKRoundLoginContainerView, NSButton, NSProgressIndicator, NSString, NSTextField, NSView;

@interface AKInlineSignInViewController : AKBaseSignInViewController <AKAppleIDAuthenticationDelegate>
{
    BOOL _usesDarkMode;
