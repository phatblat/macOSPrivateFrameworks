...
@class NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSURL, SCRBrailleLineManager, SCRCTargetSelectorTimer, SCRCThreadKey, SCRElement<SCRApplicationDirectChildProtocol>, SCREvent, SCRMenu, SCROutputSharedFocusManager, SCRUIElement, SCRVisionEngine;
