...
#import "WBSCyclerPrimaryDeviceCoordinatorDelegate.h"
#import "WBSCyclerSecondaryDeviceCoordinatorDelegate.h"

@class NSNumber, NSObject<OS_dispatch_queue>, NSString, WBSCyclerPrimaryDeviceCoordinator, WBSCyclerSecondaryDeviceCoordinator;
