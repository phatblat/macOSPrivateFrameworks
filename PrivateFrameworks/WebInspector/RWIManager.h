...
@class NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<_RWIRelayToClientMessageReceiver>, NSSet, NSString, RWIApplication, RWIBaseManager, RWITarget, SimDeviceSet, SimServiceContext;
