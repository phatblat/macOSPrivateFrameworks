...
@class CNContact, CNPostalAddressFormattingSpecification, NSArray, NSButton, NSComboBox, NSDictionary, NSPopUpButton, NSStackView, NSString, NSTextField, PKContactCountryPopUpButton, PKContactLabelMenuController, PKContactTextField;
