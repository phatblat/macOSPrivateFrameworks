...
@class CNContact, NSArray, NSButton, NSComboBox, NSPopUpButton, NSResponder, NSStackView, NSString, NSTextField, PKContactLabelMenuController, PKContactTextField;
